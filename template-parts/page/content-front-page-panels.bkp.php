...
$section_link = array('aulas/','servicos/','podcast/','https://medium.com/@pedropbittencourt','contato/');
$section_text = array('Acesse','Requisite','Ouça','Leia','Escreva');
?>
...
<article id="panel<?php echo $twentyseventeencounter; ?>" <?php post_class( 'twentyseventeen-panel ' ); ?> >
	...
	<div class="panel-content hideme" id="panel-content<?php echo $twentyseventeencounter; ?>">
		<div class="wrap">
