...
?>
<div class="site-branding branding-cv">
	<div class="wrap">
		<div class="pure-g">
			<div class="pure-u-1 pure-u-md-3-5">
				<div class="site-branding-text">
					<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">Pedro Pompermayer Bittencourt</a></h1>
					<p class="hideme site-description"><span>Professor de física e de matemática da educação básica</span></p>
